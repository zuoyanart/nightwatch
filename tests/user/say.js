...
module.exports = {
    ...
    before: function(client) {
        ...
        client
            .url(config.host + 'user/say?id=544e007daeec3f2911000001&nid=1')
            .waitForElementVisible('body', 1000)
            .pause(3000);
    },
    '前台说说是否正常打开': function(client) {
        client.expect.element('.useroper').to.be.present;
    },
    '说说未登录发表评论': function(client) {
        client.pause(2000);
        client.expect.element('.saylist li:nth-child(1) div a').to.be.present
        client.click(".saylist li:nth-child(1) div a").pause(3000);
